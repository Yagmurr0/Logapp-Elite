          ...
          children: [
            ...
            Row(
              children: [
                ...
                _buildFilterButton(LogSeverity.critical, LogSeverity.critical.displayName),
                const SizedBox(width: 8),
                _buildFilterButton(LogSeverity.warning, LogSeverity.warning.displayName),
              ],
            ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      log.severity.displayName.toUpperCase(),
                                      style: TextStyle(
                                        color: log.severity == LogSeverity.critical ? const Color(0xFFFF1744) : const Color(0xFFFFEA00),
                                        fontSize: 10,
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("${log.title} paylaşıma hazır!")));
                                },
                              )
                            ],
                          ),
